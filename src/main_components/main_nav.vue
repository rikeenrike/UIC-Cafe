      ...
      <nav>
          ...
          <div class="sidenav" v-if="isScreenWide">
            ...
            <div class="maincontainer" v-else>
              <div class="tab-container" @click="MainNavTab = '1'; router.push('/menu');"  :class="{ active: MainNavTab === '1' }">
                <ul>MENU</ul>
              </div>
              
              <div class="tab-container" @click="MainNavTab = '2'; router.push('/bestsellers');" :class="{ active: MainNavTab === '2' }">
                <ul>BEST SELLERS</ul>
              </div>
